...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM `cowner` WHERE email = '$email' AND password = '$pass'") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>don't have an account? <a href="cReg.php">regiser now</a></p>
   </form>
