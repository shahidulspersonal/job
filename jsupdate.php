...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `JobSeeker` SET name = '$update_name', email = '$update_email' WHERE id = '$user_id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="jobseeker.php" class="delete-btn">go back</a>
   </form>
